...
# Generates squared distance functions, gradients and hessians
# double d2_{pp,pe,pt,ee}(q1, ..., q2, ...)
# Eigen::VectorXd d2_{pp,pe,pt,ee}_grad(q1, ..., q2, ...)
# Eigen::MatrixXd d2_{pp,pe,pt,ee}_hess(q1, ..., q2, ...)
...
print(d_grad_hess_fns(d2_pp_fns, d2_pp_expr))
...
print(d_grad_hess_fns(d2_pe_fns, d2_pe_expr))
...
print(d_grad_hess_fns(d2_pt_fns, d2_pt_expr))
...
print(d_grad_hess_fns(d2_ee_fns, d2_ee_expr))
